...
function extractSaml20Options(opts) {
  return {
    ...
    transformAssertion: opts.transformAssertion
  };
}
 ...
 * @param [options.transformAssertion] {Function}
 *
 * // XML Dsig
...
function createAssertion(options, strategies, callback) {
  ...
  if (options.transformAssertion instanceof Function) {
    options.transformAssertion(doc);
  }
